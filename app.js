...
app.get('/tengerimalac-jatek', async (req, res) => {
  res.send(getStyle() + getMenu() + '<div class="container"><h1>🐹 Tengerimalac Kaland</h1><p>A játék hamarosan elérhető lesz!</p></div>');
});
...
app.get('/tetris', (req, res) => {
  res.send(getStyle() + getMenu() + '<div class="container"><h1>🟦 Tetris</h1><p>A játék hamarosan elérhető lesz!</p></div>');
});

app.get('/snake', (req, res) => {
  res.send(getStyle() + getMenu() + '<div class="container"><h1>🐍 Snake</h1><p>A játék hamarosan elérhető lesz!</p></div>');
});

app.get('/labirintus', (req, res) => {
  res.send(getStyle() + getMenu() + '<div class="container"><h1>🎯 Labirintus</h1><p>A játék hamarosan elérhető lesz!</p></div>');
});
